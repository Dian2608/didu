...
The package also consists of 2 datasets named `tidy_dengue` and `dengue_flu`. These datasets will help with a quick start and introduction to the functions in the didu package.   
